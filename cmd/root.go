...
const (
	moduleShortName   = "azks"
	configFileName    = "azks-config.json"
...
var rootCmd = &cobra.Command{
	Use:  "azks",
	Long: `AzKS module is responsible for providing Azure Kubernetes Services resource.`,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&logLevelFlag, "loglevel", "l", "info",
		"Log level flag: panic, fatal, error, warn, info, debug, trace (default: info)")
